#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""english-b-2026-06.json generator (key: en-b)
中1 英語 期末対策 P20〜33（海輝君用）。
...
data = {
    "title": "英語 P20〜33 期末対策",
    "subtitle": "中1 重要単語にしぼって｜🔊音声つき",
    "icon": "📖",
    "modes": {
...
out = os.path.join(os.path.dirname(os.path.abspath(__file__)), "english-b-2026-06.json")
